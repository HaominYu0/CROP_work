...
class DimeNetPlusPlusWrap(DimeNetPlusPlus):
    ...
    def forward(self, data):
        ...
        x_att_ = x_att.clone().detach() 
        _, _, idx_i, idx_j, idx_k, idx_kj, idx_ji, x_atti__ = self.triplets(
        ...
        return P, energy, gt_edge.long(), edge_attr_whole, x_att_
