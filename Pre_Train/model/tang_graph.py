...
num_bond_type = 27 #including aromatic and self-loop edge, and extra masked tokens
...
class GINConv(MessagePassing):
    ...
    def __init__(self, emb_dim, out_dim, aggr = "add", **kwargs):
        ...
        self.edge_embedding3 = torch.nn.Linear(1, emb_dim)
    ...
    def forward(self, x, edge_index, edge_attr):
        ...
        #import ipdb
        #ipdb.set_trace()
        edge_embeddings = self.edge_embedding1(edge_attr[:,0].long()) + self.edge_embedding2(edge_attr[:,1].long())+  self.edge_embedding3(edge_attr[:,2].unsqueeze(dim=-1))
...
class GraphSAGEConv(MessagePassing):
    ...
    def forward(self, x, edge_index, edge_attr):
        ...
        edge_embeddings = self.edge_embedding1(edge_attr[:,0]) + self.edge_embedding2(edge_attr[:,1])+ self.edge_embedding2(edge_attr[:,2])
...
class GNN(torch.nn.Module):
    ...
    def __init__(self, num_layer, emb_dim, JK = "last", drop_ratio = 0, gnn_type = "gin"):
        ...
        self.x_embedding3 = torch.nn.Embedding(1, emb_dim)
    ...
    #def forward(self, x, edge_index, edge_attr):
    # BatchMasking(masked_atom_indices=[1383], mask_node_label=[1383, 2], y=[157952], edge_index=[2, 10058], id=[256],
    #              x=[4895, 2], edge_attr=[10058, 2], node_attr_label=[1383, 119], batch=[4895])
    def forward(self, *argv):
        ...
        x = self.x_embedding1(x)# + self.x_embedding2(x[:,1])
        ...
        return node_representation #node_representation.shape(edge_num, latent_dim)
